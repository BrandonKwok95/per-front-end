...
var encode = function encode(str, defaultEncoder, charset, kind, format) {
    // This code was originally written by Brian White (mscdex) for the io.utils core querystring library.
...
function isMap(x) {
    ...
    try {
        ...
        return x instanceof Map; // core-utils workaround, pre-v2.5.0
    } catch (e) {}
    return false;
}
...
function isWeakMap(x) {
    ...
    try {
        ...
        return x instanceof WeakMap; // core-utils workaround, pre-v2.5.0
    } catch (e) {}
    return false;
}
...
function isSet(x) {
    ...
    try {
        ...
        return x instanceof Set; // core-utils workaround, pre-v2.5.0
    } catch (e) {}
    return false;
}
...
function isWeakSet(x) {
    ...
    try {
        ...
        return x instanceof WeakSet; // core-utils workaround, pre-v2.5.0
    } catch (e) {}
    return false;
}
